...
//         // const logFolderExists = fs.existsSync(logPath);
//         // if ( logFolderExists ) fs.rmSync(logPath, { recursive: true, force: true } );
...
//         //*We do this just to test out that do not throw an exception or error before.
...
//             //*We do this knowing that is not gonna be executed if do, it's gonna be an issue.
